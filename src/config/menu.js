...
export const MENU = [
  { path: '/home', title: '首页', icon: HomeFilled },
  {
    ...
    children: [
      ...
      { path: '/workorder/dispatch', title: '待派单', icon: Promotion, roles: ['DISPATCHER'] },
      { path: '/workorder/assigned', title: '我负责的', icon: UserFilled, roles: ['HANDLER'] },
    ],
  },
  {
    title: '系统管理',
    ...
    roles: ['ADMIN'],
    children: [
      { path: '/admin/workorders', title: '全部工单', icon: Tickets, roles: ['ADMIN'] },
      { path: '/admin/users', title: '用户管理', icon: UserFilled, roles: ['ADMIN'] },
      { path: '/admin/departments', title: '部门管理', icon: Document, roles: ['ADMIN'] },
    ],
  },
]
